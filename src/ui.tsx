...
const BASE_URL = "https://deno-link-john.deno.dev";
      ...
      <div className="hero min-h-[500px] bg-base-200 rounded-box">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold">Welcome to Deno.link</h1>
            <p className="py-6">
              Deno.link is a Deno-powered URL shortening service.
              Create, manage, and track your links with just one click.
            </p>
            {user
              ? (
